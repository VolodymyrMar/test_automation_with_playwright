...
from .demo_pages import DemoPage
...
class App:
    def __init__(self, browser: Browser, base_url: str, **kwargs):
        ...
        self.demo_pages = DemoPage(self.page)
    ...
    def intercept_requests(self, url: str, playload: str):
        def handler(route: Route, request: Request):
            route.fulfill(status=200, body=playload)

        return self.page.route(url, handler)
